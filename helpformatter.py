from typing import Iterable, Any, List, Callable, Tuple
import discord.ext.commands as dec
import inspect


class DdmBotHelpFormatter(dec.DefaultHelpCommand):
    ...
    @staticmethod
    def _partition(predicate: Callable[[Any], bool], iterable: Iterable[Any]) -> Tuple[List[Any], List[Any]]:
        trues = []
        falses = []
    ...
    #  TODO: Reimplement the formatting using the new style. This doesn't work with discord-py 1.0.
    # def format(self):
    ...
    #
    #     description = self.command.description if self.cog is not None else inspect.getdoc(self.command)
    #
    #     if description:
    #         # <description> portion
